...
class FcActorCriticNetwork(nn.Module):
    def __init__(self, input_size, output_size, use_noisy_net=False):
        super(FcActorCriticNetwork, self).__init__()
        ...
        self.critic_ext = linear(64, 1)
        self.critic_int = linear(64, 1)
...
class FcRNDModel(nn.Module):
    def __init__(self, input_size, output_size):
        super(FcRNDModel, self).__init__()
...
class ICMModel(nn.Module):
    def __init__(self, input_size, output_size, use_cuda=True, use_contrastive=False):
